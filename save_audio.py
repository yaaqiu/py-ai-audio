...
def main():
    ...
    # 定义要合成的音轨
    tracks = [
        {"path": r"E:\python\ai_audio\audio\风吹树叶.mp3", "name": "Wind", "volume": 0.3},
        {"path": r"E:\python\ai_audio\audio\鸟叫.mp3", "name": "Birds", "volume": 0.2},
        {"path": r"E:\python\ai_audio\audio\雨声.mp3", "name": "Rain", "volume": 0.25}
    ]
